define(['jquery', 'bootstrap', 'backend', 'table', 'form'], function ($, undefined, Backend, Table, Form) {
    ...
    var Controller = {
        index: function () {
            ...
            Table.api.init({
                extend: {
                    index_url: 'employees/employees/index' + location.search,
                    add_url: 'employees/employees/add',
                    edit_url: 'employees/employees/edit',
                    del_url: 'employees/employees/del',
                    multi_url: 'employees/employees/multi',
                    import_url: 'employees/employees/import',
                    table: 'employees',
                }
            });
        ...
        recyclebin: function () {
            ...
            // 初始化表格
            table.bootstrapTable({
                url: 'employees/employees/recyclebin' + location.search,
                pk: 'id',
                sortName: 'id',
                columns: [
                    [
                            ...
                            buttons: [
                                {
                                    ...
                                    url: 'employees/employees/restore',
                                    refresh: true
                                },
                                {
                                    name: 'Destroy',
                                    ...
                                    icon: 'fa fa-times',
                                    url: 'employees/employees/destroy',
                                    refresh: true
                                }
                            ],
